...
ui <- fluidPage(
  ...
  mainPanel(
    p("Infant Mortality Rate represents the number of deaths per 1000 births of children less than 1 year of age."), 
    p("Use the dropdown menu to the right to review clustering results for a specific year (2009 through 2019). You can also adjust the number of clusters by typing in a value between 2 and 8, inclusive."),
    p("The data being clustered include Infant Mortality Rate, Latitude, and Longitude for 177 countries"))),
  plotOutput("plot1")
) 
